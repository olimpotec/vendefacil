...
CREATE TABLE _contact (
    ...
    _send_date timestamp without time zone DEFAULT now() NOT NULL,
    _responser integer,
...
CREATE TABLE _file (
    ...
    _create_date timestamp without time zone DEFAULT now() NOT NULL,
...
SELECT pg_catalog.setval('_file__id_seq', 1, true);
...
SELECT pg_catalog.setval('_group__id_seq', 3, true);
...
CREATE TABLE _media (
    ...
    _size integer DEFAULT 0 NOT NULL,
    _description character varying(256),
    _insert timestamp without time zone DEFAULT now() NOT NULL,
    _update timestamp without time zone DEFAULT now() NOT NULL,
    _user integer NOT NULL
);
...
CREATE TABLE _simple (
    ...
    _content text,
    _user integer NOT NULL,
    _update_date timestamp without time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE _user (
    ...
    _create_date timestamp without time zone DEFAULT now() NOT NULL,
    _update_date timestamp without time zone DEFAULT now() NOT NULL,
    _last_logon timestamp without time zone DEFAULT now() NOT NULL,
...
ALTER TABLE _contact ALTER COLUMN _id SET DEFAULT nextval('_contact__id_seq'::regclass);
...
ALTER TABLE _file ALTER COLUMN _id SET DEFAULT nextval('_file__id_seq'::regclass);
...
ALTER TABLE _group ALTER COLUMN _id SET DEFAULT nextval('_group__id_seq'::regclass);
...
ALTER TABLE _media ALTER COLUMN _id SET DEFAULT nextval('_media__id_seq'::regclass);
...
ALTER TABLE _rss ALTER COLUMN _id SET DEFAULT nextval('_rss__id_seq'::regclass);
...
ALTER TABLE _user ALTER COLUMN _id SET DEFAULT nextval('_user__id_seq'::regclass);
...
COPY _file (_id, _name, _mimetype, _size, _description, _create_date, _user) FROM stdin;
1	titan.png	image/png	37240		2010-04-12 23:09:02.913	1
\.
...
teste_1	Teste 01	Apenas um teste...	\N	1	2010-04-12 21:47:18.907	2010-04-12 21:48:00.576
teste_2	Teste 2		\N	2	2010-04-12 22:09:16.115	2010-04-12 22:10:15.123
tcc	TCC 2010 AS ZZZ	WebApp de Gest?do Projeto de TCC...	1	1	2010-04-12 23:02:24.869	2010-04-12 23:06:49.108
\.
...
ACCESS_SECTION_net.ledes.home	1
ACCESS_ACTION_net.ledes.home_home	1
ACCESS_ACTION_net.ledes.home_profile	1
ACCESS_ACTION_net.ledes.home_personal	1
ACCESS_SECTION_net.ledes.creator	1
ACCESS_ACTION_net.ledes.creator_list	1
ACCESS_ACTION_net.ledes.creator_step_1	1
ACCESS_ACTION_net.ledes.creator_step_2	1
ACCESS_ACTION_net.ledes.creator_step_3	1
ACCESS_ACTION_net.ledes.creator_step_4	1
ACCESS_ACTION_net.ledes.creator_create	1
ACCESS_ACTION_net.ledes.creator_edit	1
PERMISSION_net.ledes.creator__VIEW_ALL_	1
ACCESS_SECTION_net.ledes.archive	1
ACCESS_ACTION_net.ledes.archive_list	1
ACCESS_ACTION_net.ledes.archive_create	1
ACCESS_SECTION_net.ledes.access	1
ACCESS_ACTION_net.ledes.access_list	1
ACCESS_ACTION_net.ledes.access_create	1
ACCESS_ACTION_net.ledes.access_edit	1
ACCESS_ACTION_net.ledes.access_delete	1
ACCESS_ACTION_net.ledes.access_view	1
ACCESS_ACTION_net.ledes.access_permissionGroup	1
ACCESS_ACTION_net.ledes.access_userGroup	1
ACCESS_ACTION_net.ledes.access_typeGroup	1
ACCESS_ACTION_net.ledes.access_mailGroup	1
ACCESS_ACTION_net.ledes.access_log	1
ACCESS_ACTION_net.ledes.access_logView	1
PERMISSION_net.ledes.access_SET_ADMIN	1
ACCESS_SECTION_net.ledes.manager	1
ACCESS_ACTION_net.ledes.manager_list	1
ACCESS_ACTION_net.ledes.manager_create	1
ACCESS_ACTION_net.ledes.manager_edit	1
ACCESS_ACTION_net.ledes.manager_delete	1
ACCESS_ACTION_net.ledes.manager_view	1
ACCESS_ACTION_net.ledes.manager_graph	1
ACCESS_SECTION_net.ledes.architect	1
ACCESS_ACTION_net.ledes.architect_list	1
ACCESS_ACTION_net.ledes.architect_create	1
ACCESS_ACTION_net.ledes.architect_edit	1
ACCESS_ACTION_net.ledes.architect_delete	1
ACCESS_ACTION_net.ledes.architect_view	1
ACCESS_SECTION_net.ledes.home	2
ACCESS_ACTION_net.ledes.home_home	2
ACCESS_ACTION_net.ledes.home_profile	2
ACCESS_ACTION_net.ledes.home_personal	2
ACCESS_SECTION_net.ledes.creator	2
ACCESS_ACTION_net.ledes.creator_list	2
ACCESS_ACTION_net.ledes.creator_step_1	2
ACCESS_ACTION_net.ledes.creator_step_2	2
ACCESS_ACTION_net.ledes.creator_step_3	2
ACCESS_ACTION_net.ledes.creator_step_4	2
ACCESS_ACTION_net.ledes.creator_create	2
ACCESS_ACTION_net.ledes.creator_edit	2
\.
...
COPY _user (_id, _name, _login, _password, _active, _email, _deleted, _type, _language, _create_date, _update_date, _last_logon, street, number, quarter, cep, city, state, phone, mobile, complement, msn, skype, photo, url, orkut, cpf, birthday, gender, marriage) FROM stdin;
1	Administrador	admin	d033e22ae348aeb5660fc2140aec35850c4da997	1	camilo@ufms.br	0	net.ledes.manager	pt_BR	2010-03-03 18:51:50.859	2010-03-03 18:51:50.859	2010-04-12 23:00:06.464	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	_M_	_OTHER_
2	Teste da Silva	test	d033e22ae348aeb5660fc2140aec35850c4da997	1	camilo@carromeu.com	0	net.ledes.manager	pt_BR	2010-04-12 21:14:45.311	2010-04-12 21:14:45.311	2010-04-13 03:54:23.148	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	_M_	_OTHER_
\.
